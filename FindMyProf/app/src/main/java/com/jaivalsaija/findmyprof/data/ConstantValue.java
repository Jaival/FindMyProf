...
public class ConstantValue {
    private static final String Root_Url = "http://192.168.43.226/findmyprofdb/scripts/";
//    private static final String Root_Url = "http://192.168.43.227/findmyprofdb/scripts/";
    ...
    public static final String Url_Stud_Send_Notify = Root_Url + "singleStudentPush.php";
    public static final String Url_Prof_Send_Notify = Root_Url + "singleProfessorPush.php";
    public static final String Url_Save_History = Root_Url + "addHistory.php";
    public static final String Url_Get_History = Root_Url + "selectHistoryForNotify.php";
    public static final String Url_History = Root_Url + "selectHistory.php";
    public static final String Url_Accept_Reject = Root_Url + "updateHistory.php";
